...
@section('content')
    ...
    <div class="sm:px-0 px-4">
        <div class="max-w-4xl mx-auto bg-white relative  -mt-20 z-20 rounded sm:px-12 px-4 sm:py-12 py-4 border-b border-red-600 min-h-[40vh] text-sm">
            ...
            <p>Metodologi yang digunakan disajikan dalam ATBD (Algorithm Theoretical Basis Documents) </p>
            ...
            <ul class="list-decimal mt-4 flex flex-col gap-2">
                ...
                <li class="ml-6"><strong>Evaluasi dan validasi hasil klasifikasi kebakaran dengan pengamatan visual.</strong> Hasil dari klasifikasi divalidasi dengan menggunakan data referensi, validasi ini digunakan menggunakan pengecekan visual terhadap peta areal terbakar untuk memastikan akurasi data yang ada.                </li>
            </ul>
        </div>
    </div>
