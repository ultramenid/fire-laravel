<div class="">
    ...
    <div class=" border-b border-gray-300 dark:border-opacity-20 ">
        <div class="max-w-4xl mx-auto px-10  flex justify-between  py-16">
            <h1 class="sm:text-4xl text-xl text-newgray-900 dark:text-newgray-300 font-semibold ">New posts</h1>
            <div class="z-30">
        ...
        <div class="sm:col-span-9 col-span-12 " >
            ...
            <div x-show="tabs==='english'" x-cloak style="display: none !important">
                ...
                <div class="w-full border border-gray-300 dark:border-opacity-20  px-6 py-6 mb-6">
                    <h1 class="text-xl font-semibold  text-newbg-newgray-900 dark:text-gray-300 mb-4">Content</h1>
                    <div class="w-full  "
                        wire:ignore
                        x-init="
                        tinymce.init({
