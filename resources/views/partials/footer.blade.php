            ...
            <div class="flex sm:flex-row flex-col items-center overflow overflow-auto sm:gap-32 gap-4">
                <div class="w-full sm:w-10/12 ">
                    ...
                    <div class="flex justify-between w-full flex-wrap">
                        <a href="https://auriga.or.id/" target="_blank" >
                            <img class="h-10 mt-2" src="https://mapbiomas.id/assets/logos/AurigaPNG.png" alt="">
                        </a>
                        <a href="https://www.jeratpapua.org/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo2_color.png" alt="" class="h-12 ">
                        </a>
                        <a href="https://saveourborneo.org/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo3_color.png" alt="" class="h-12">
                        </a>
                        <a href="http://greenofborneo.id/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo4_color.png" alt="" class="h-12">
                        </a>
                        <a href="https://www.haka.or.id/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo5-x.png" alt="" class="h-12">
                        </a>
                        <a href="http://mnukwarpapua.id/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo6-x.png" alt="" class="h-12">
                        </a>
                        <a href="https://hutaninstitute.or.id/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo7-x.png" alt="" class="h-12">
                        </a>
                        <a href="http://yayasangenesisbengkulu.or.id/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo8-x.png" alt="" class="h-12">
                        </a>
                         <a href="https://komiu.id/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo9-x.png" alt="" class="h-12">
                        </a>
                        <a href="http://sampankalimantan.id/" target="_blank" >
                            <img src="https://mapbiomas.id/assets/logos/logo10-x.png" alt="" class="h-12">
                        </a>
                ...
                <div class="sm:w-2/12 w-full">
                    ...
                    <a href="https://woods-wayside.org/" target="_blank" class="">
                        <img src="https://mapbiomas.id/assets/logos/logo12-x.png" alt="" class="h-12">
                    </a>
                </div>
